...
@Controller
public class MyQnaUpdateController {
	private final String command ="myUpdate.qna";
	private String getPage = "/myUpdateForm";
	private String gotoPage = "redirect:/myDetail.qna";
